...
def main():
    ...
    if len(sys.argv)==1:
        ...
        try:
            ...
            xaap_config.out_temp=f"./{xaap_config.deep_learning_model_name}.{xaap_config.deep_learning_model_version}_salida_temp.csv"
        ...
        try:
            ...
            #    print(detection)
            sta_lta_filename = "./sta_lta_BAJO.csv"
            if len(triggers) > 0:
        ...
        try:
            ...
            results_file_name = f"./{xaap_config.deep_learning_model_name}_{xaap_config.deep_learning_model_version}_BAJO.json"
