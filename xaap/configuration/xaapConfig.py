...
class xaapConfig():
    ...
    def __init__(self,xaap_parameter):
        ...
        self.volcan_volcanoes_configuration_file = xaap_parameter['Volcan configuration']['volcanoes_config_file']
        self.volcan_station_file = xaap_parameter['Volcan configuration']['stations_config_file']
        self.volcan_volcan_name = xaap_parameter['Volcan configuration']['volcan_name']
